...
export const ASSET_MANIFEST = [
  ...
  { key: 'icon_debt', path: 'assets/icons/icon_debt.png', type: 'image', fallback: 'debt text/icon fallback' },
  { key: 'icon_protest', path: 'assets/icons/icon_protest.png', type: 'image', fallback: 'protest marker fallback' },
  { key: 'icon_locked', path: 'assets/icons/icon_locked.png', type: 'image', fallback: 'locked text fallback' },
  { key: 'icon_max', path: 'assets/icons/icon_max.png', type: 'image', fallback: 'MAX text fallback' },
