...
export const ASSET_MANIFEST = [
  ...
  { key: 'building_whale_preview', path: 'assets/buildings/previews/building_whale_preview.png', type: 'image', fallback: 'building_golden_whale' },
  ...
  { key: 'building_vip_lounge_preview', path: 'assets/buildings/previews/building_vip_lounge_preview.png', type: 'image', fallback: 'building_vip_lounge' },
  ...
  { key: 'building_gem_exchange_preview', path: 'assets/buildings/previews/building_gem_exchange_preview.png', type: 'image', fallback: 'building_gem_exchange' },
  ...
  { key: 'building_convenience_office_preview', path: 'assets/buildings/previews/building_convenience_office_preview.png', type: 'image', fallback: 'building_convenience_office' },
  ...
  { key: 'item_morale_stew', path: 'assets/items/item_morale_stew.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_honest_training_scroll', path: 'assets/items/item_honest_training_scroll.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_wooden_shield', path: 'assets/items/item_wooden_shield.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_iron_sword', path: 'assets/items/item_iron_sword.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_adventurer_boots', path: 'assets/items/item_adventurer_boots.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_sword_of_unfair_advantage', path: 'assets/items/item_sword_of_unfair_advantage.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_best_value_bundle', path: 'assets/items/item_best_value_bundle.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_starter_pack_day_7', path: 'assets/items/item_starter_pack_day_7.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_pity_timer_charm', path: 'assets/items/item_pity_timer_charm.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_rngesus_blessing', path: 'assets/items/item_rngesus_blessing.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_debt_contract', path: 'assets/items/item_debt_contract.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_refund_denial_stamp', path: 'assets/items/item_refund_denial_stamp.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_dynamic_pricing_scroll', path: 'assets/items/item_dynamic_pricing_scroll.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_interest_rate_totem', path: 'assets/items/item_interest_rate_totem.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_complaint_ticket', path: 'assets/items/item_complaint_ticket.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_audit_scarecrow', path: 'assets/items/item_audit_scarecrow.png', type: 'image', fallback: 'inventory text' },
  { key: 'item_shiny_disappointment_box', path: 'assets/items/item_shiny_disappointment_box.png', type: 'image', fallback: 'inventory text' },
  ...
  { key: 'fort_palisade_straight', path: 'assets/fortifications/palisade_straight_nw_se.png', type: 'image', fallback: 'object_fence_wood' },
  { key: 'fort_palisade_corner', path: 'assets/fortifications/palisade_corner_ne.png', type: 'image', fallback: 'fort_palisade_straight' },
  { key: 'fort_palisade_connector', path: 'assets/fortifications/palisade_connector_ne.png', type: 'image', fallback: 'fort_palisade_straight' },
  { key: 'fort_palisade_damaged', path: 'assets/fortifications/palisade_damaged.png', type: 'image', fallback: 'fort_palisade_straight' },
  { key: 'fort_palisade_heavy', path: 'assets/fortifications/palisade_heavy.png', type: 'image', fallback: 'fort_palisade_damaged' },
  { key: 'fort_palisade_breached', path: 'assets/fortifications/palisade_breached.png', type: 'image', fallback: 'broken_shield' },
  { key: 'fort_stone_straight', path: 'assets/fortifications/stone_wall_straight_nw_se.png', type: 'image', fallback: 'fort_palisade_straight' },
  { key: 'fort_stone_damaged', path: 'assets/fortifications/stone_wall_damaged.png', type: 'image', fallback: 'fort_stone_straight' },
  { key: 'fort_stone_heavy', path: 'assets/fortifications/stone_wall_heavy.png', type: 'image', fallback: 'fort_stone_damaged' },
  { key: 'fort_stone_breached', path: 'assets/fortifications/stone_wall_breached.png', type: 'image', fallback: 'rock' },
  { key: 'fort_gate_wood_open', path: 'assets/fortifications/gate_wood_open.png', type: 'image', fallback: 'poi_paywall_gate' },
  { key: 'fort_gate_wood_closed', path: 'assets/fortifications/gate_wood_closed.png', type: 'image', fallback: 'poi_paywall_gate' },
  { key: 'fort_gate_wood_damaged', path: 'assets/fortifications/gate_wood_damaged.png', type: 'image', fallback: 'fort_gate_wood_closed' },
  { key: 'fort_gate_wood_breached', path: 'assets/fortifications/gate_wood_breached.png', type: 'image', fallback: 'broken_shield' },
  { key: 'fort_gatehouse_open', path: 'assets/fortifications/gatehouse_open.png', type: 'image', fallback: 'building_dungeon_gate' },
  { key: 'fort_gatehouse_closed', path: 'assets/fortifications/gatehouse_closed.png', type: 'image', fallback: 'building_dungeon_gate' },
  { key: 'fort_gatehouse_damaged', path: 'assets/fortifications/gatehouse_closed.png', type: 'image', fallback: 'fort_gatehouse_closed' },
  { key: 'fort_gatehouse_breached', path: 'assets/fortifications/gate_wood_breached.png', type: 'image', fallback: 'fort_gate_wood_breached' },
  { key: 'fort_tower_wood', path: 'assets/fortifications/tower_wood.png', type: 'image', fallback: 'building_watchtower' },
  { key: 'fort_tower_wood_damaged', path: 'assets/fortifications/tower_wood.png', type: 'image', fallback: 'fort_tower_wood' },
  { key: 'fort_tower_stone', path: 'assets/fortifications/tower_stone.png', type: 'image', fallback: 'building_watchtower' },
  { key: 'fort_tower_stone_damaged', path: 'assets/fortifications/tower_stone.png', type: 'image', fallback: 'fort_tower_stone' },
